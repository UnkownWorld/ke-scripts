...
class NetworkTrainer:
    ...
    def get_text_embedding(tokenizer, text_encoder, batch, accelerator, args, clip_skip=True, weight_dtype=None):
    ...
    def process_latents(batch, vae, vae_dtype, weight_dtype, vae_scale_factor):
