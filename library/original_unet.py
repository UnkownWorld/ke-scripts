...
class UNet2DConditionModel(nn.Module):
    ...
    def set_pool_weight(self,loss,is_first,step):
        if(is_first):
            ...
            print(f"the pool weight try before:{pool_weight[step]} and pool_weight {pool_weight}")
            ...
            print(f"the pool weight try:{pool_weight[step]} and pool_weight {pool_weight}")
